...
- Primary endpoint start/stop/switch actions; compose compute lifecycle orchestration is implemented, branch-to-timeline compute attachment wiring remains.
